...
namespace InfoPanel.TuringPanel
{
    public static class TuringPanelModelDatabase
    {
        public static readonly Dictionary<TuringPanelModel, TuringPanelModelInfo> Models = new()
        {
            ...
            [TuringPanelModel.REV_13INCH_USB] = new TuringPanelModelInfo { Model = TuringPanelModel.REV_13INCH_USB, Name = "TURZX 10.2\"", Width = 440, Height = 1920, VendorId = 0x1a86, ProductId = 0xca11, IsUsbDevice = false },
        };
