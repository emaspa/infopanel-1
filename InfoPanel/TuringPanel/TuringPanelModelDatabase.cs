...
namespace InfoPanel.TuringPanel
{
    public static class TuringPanelModelDatabase
    {
        public static readonly Dictionary<TuringPanelModel, TuringPanelModelInfo> Models = new()
        {
            ...
            [TuringPanelModel.REV_13INCH_USB] = new TuringPanelModelInfo { Model = TuringPanelModel.REV_13INCH_USB, Name = "TURZX 13\"", Width = 480, Height = 1920, VendorId = 0x0525, ProductId = 0xa4a7, IsUsbDevice = false },
        };
