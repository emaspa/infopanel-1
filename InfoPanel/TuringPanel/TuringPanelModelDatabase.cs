...
namespace InfoPanel.TuringPanel
{
    public static class TuringPanelModelDatabase
    {
        public static readonly Dictionary<TuringPanelModel, TuringPanelModelInfo> Models = new()
        {
            ...
            [TuringPanelModel.REV_13INCH_USB] = new TuringPanelModelInfo { Model = TuringPanelModel.REV_13INCH_USB, Name = "TURZX 13\"", Width = 1920, Height = 462, VendorId = 0x1a86, ProductId = 0xca11, IsUsbDevice = true },
        };
